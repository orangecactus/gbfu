...
// $this->sections[] = array(
            ...
            //     'desc'   => esc_html__( 'Description Goes Here', 'eventr' ),
...
if ( !function_exists( 'wbc_importer_description_text' ) ) {
	...
	function wbc_importer_description_text( $description ) {
		...
		$message = '<p>'. esc_html__( 'Best if used on new WordPress install.', 'eventr' ) .'</p>';
		$message .= '<p>'. esc_html__( 'Images are for demo purpose only.', 'eventr' ) .'</p>';
